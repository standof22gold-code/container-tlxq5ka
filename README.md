...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tlxq5ka.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tlxq5ka.containers.anotherwebservice.com/
...
```
git clone git@github.com:standof22gold-code/container-tlxq5ka.git
cd container-tlxq5ka
```
...
```
docker attach container-tlxq5ka
```
